...
In addition, the developer seeks to better understand feature adoption within the application—currently it is understood based only on user feedback in email. The developer would also like to incorporate a lightweight solution to update users' Microsoft Bands at scheduled intervals regardless of the devices they are paired to.

## Solutions, steps, and delivery ##

1. Migrate code base into VSTS. 
...
3. Port from Windows 8.1 to UWP. 
	...
	![UWP Port]( {{ site.baseurl }}/images/2016-09-09-fanband/ReleaseWindows.PNG)  
