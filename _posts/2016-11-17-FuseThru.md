...
|---------------------------------|--------|------------|------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------|
| PushQueryStreamAnalytics        | EventHub | EventHub        | ![Stream Analytics]({{ site.baseurl }}/images/fusethru_streamanalytics.png)                          | Sends all data points to an event hub to be consumed by the dashboard.                                            |
