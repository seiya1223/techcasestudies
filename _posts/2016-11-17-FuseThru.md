...
|---------------------------------|--------|------------|------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------|
| PushQueryStreamAnalytics        | EventHub | EventHub        | <img src="{{ site.baseurl }}/images/ fusethru_streamanalytics.png" width="50">                          | Sends all data points to an event hub to be consumed by the dashboard.                                            |
