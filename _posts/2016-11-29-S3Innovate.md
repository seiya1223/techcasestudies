...
-	Augment the existing infrastructure to use Azure Event Hubs or Azure IoT Hub for data ingestion instead of a REST endpoint running on a virtual machine.
...
-	Choose to implement a version 2.0 of their hardware from the list below (non-exhaustive classification).
...
<img src="{{ site.baseurl }}/images/s3innovate/nodemcu.jpg" width="750">
