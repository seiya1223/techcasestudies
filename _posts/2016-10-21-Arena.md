...
![Arena's CEO Paulo, and CTO Rodrigo]({{ site.baseurl }}/images/Arena/1.JPG)
...
![Rodrigo reviewing the Azure Portal for the Arena Azure App Service]({{ site.baseurl }}/images/Arena/2.JPG)
