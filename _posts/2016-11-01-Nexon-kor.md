---
layout: post
title: "Building Real-time & Batch Game Data Predictive Analytics with Azure Web App and Function App"
...
excerpt: In this Azure Web App & Function App Hackfest, developed with a leading game publisher & studio Nexon, to build real-time and batch predictive analytics on gaming data. In this document, will describe the whole solution code and the result.
verticals: Game
language: Korean
---
...
![Predictive Analytics Architecture Diagram](../images/nexon21.png)  
...
![Real-time Predictive Analytics Architecture Diagram](../images/nexon22.png)  
...
![Azure Machine Learning Game User Churn Analytics Predict Model](../images/nexon31.png)  
Azure Machine Learning - 게임 사용자 이탈율 예측 모델  

![Azure Machine Learning Game User Churn Analytics column select](../images/nexon33.png)  
...
![Azure Machine Learning Game User Churn Analytics column select](../images/nexon13.png)
...
![Real-time Predictive Analytics Architecture Diagram](../images/nexon23.png)  
...
![Nexon hackfest coding](../images/nexon14.png)  
...
- 명대성 - 디에스이트레이드, 차장
- 박고은 - 디에스이트레이드, 대리
- 구예진 - 마이크로소프트, Audienct Evangelism Manager
- 김대우 - 마이크로소프트, Sr. Technical Evangelist
- 류혜원 - 마이크로소프트, Audienct Evangelism Manager
...
![Nexon hackfest members](../images/nexon05.jpg)  
