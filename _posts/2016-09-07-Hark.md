...
![Architecture]( {{ site.baseurl }}/images/hark_architecture.jpg)

![Hack architecture]( {{ site.baseurl }}/images/hark_hack_arch.png)
...
![Room planning]( {{ site.baseurl }}/images/hark_room_planning.jpg)

![Jordan planning]( {{ site.baseurl }}/images/hark_jordan_planning.jpg)

![Andrew planning]( {{ site.baseurl }}/images/hark_andrew_planning.jpg)


### Front End

![Tophat build test stage]( {{ site.baseurl }}/images/hark_tophat_build_test_stage.jpg)

![Tophat stage prod]( {{ site.baseurl }}/images/hark_tophat_stage_prod.jpg)

### SenseNet

![Sensenet build]( {{ site.baseurl }}/images/hark_sensenet_build.jpg)

![Sensenet test]( {{ site.baseurl }}/images/hark_sensenet_test.jpg)

![Sensenet staging production]( {{ site.baseurl }}/images/hark_sensenet_staging_production.jpg)

### Database

![Sensenet db test]( {{ site.baseurl }}/images/hark_sensenet_db_test.jpg)

![Sensenet db production]( {{ site.baseurl }}/images/hark_sensenet_db_production.jpg)
...
![Monitoring]( {{ site.baseurl }}/images/hark_monitoring.jpg)

At the end of the day we discussed what areas Hark felt would be most beneficial to be the focus of a hack.

![Need help with]( {{ site.baseurl }}/images/hark_need_help_with.jpg)
...
![Hack arch new]( {{ site.baseurl }}/images/hark_hack_arch_new.png)
...
![Dotnet build problems]( {{ site.baseurl }}/images/hark_dotnet_build_problems.jpg)
...
![NuGet download]( {{ site.baseurl }}/images/hark_NuGetDownload.png)
...
![Zip package]( {{ site.baseurl }}/images/hark_ZipPackage.PNG)
...
![Release pipeline]( {{ site.baseurl }}/images/hark_ReleasePipeline.PNG)
...
![Postman write test]( {{ site.baseurl }}/images/hark_postman_write_test.png)
...
![Postman collection]( {{ site.baseurl }}/images/hark_postman_collection.png)
...
![Postman files]( {{ site.baseurl }}/images/hark_postman_files.png)
...
![Newman task]( {{ site.baseurl }}/images/hark_NewmanTask.PNG)
