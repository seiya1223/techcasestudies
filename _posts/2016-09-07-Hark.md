...
# Learnings from a Hackfest with Hark
...
![Architecture](/images/hark_architecture.jpg)

![Hack architecture](/images/hark_hack_arch.png)
...
![Room planning](/images/hark_room_planning.jpg)

![Jordan planning](/images/hark_jordan_planning.jpg)

![Andrew planning](/images/hark_andrew_planning.jpg)


### Front End

![Tophat build test stage](/images/hark_tophat_build_test_stage.jpg)

![Tophat stage prod](/images/hark_tophat_stage_prod.jpg)

### SenseNet

![Sensenet build](/images/hark_sensenet_build.jpg)

![Sensenet test](/images/hark_sensenet_test.jpg)

![Sensenet staging production](/images/hark_sensenet_staging_production.jpg)

### Database

![Sensenet db test](/images/hark_sensenet_db_test.jpg)

![Sensenet db production](/images/hark_sensenet_db_production.jpg)
...
![Hack group](/images/hark_hack_group.jpg)
...
![Hack arch new](/images/hark_hack_arch_new.png)
...
![Automation script](/images/hark_automation_script.png)

Once the template was exported a number of errors were presented:

![Automation script error bar](/images/hark_automation_script_error_bar.png)

![Automation script errors](/images/hark_automation_script_errors.png)
...
![Dotnet build problems](/images/hark_dotnet_build_problems.jpg)

**Needed dotnet restore**

![Lock file error](/images/hark_lock_file_error.PNG)
...
![NuGet download](/images/hark_NuGetDownload.png)
...
![Publish API](/images/hark_PublishAPI.PNG)
...
![Release pipeline](/images/hark_ReleasePipeline.PNG)
...
![Postman write test](/images/hark_postman_write_test.png)
...
![Postman collection](/images/hark_postman_collection.png)
...
![Postman files](/images/hark_postman_files.png)
...
![Newman task](/images/hark_NewmanTask.PNG)
