---
layout: post
title:  "Azure IoT lights up a group rowing studio"
...
In this project, Microsoft worked together with startup Regatta to create a software solution for its new group rowing studio.
...
<img src="/images/regatta/baiyin.jpg" width="100">

<img src="/images/regatta/stephanie.jpg" width="100">

<img src="/images/regatta/codefoster.png" width="100">

<img src="/images/regatta/danielegan.jpg" width="100">

<img src="/images/regatta/timmyreilly.jpg" width="100">

<img src="/images/regatta/rachel.jpg" width="100">
...
Microsoft and Regatta worked together on a project to use the power of IoT and the cloud to capture some of these new opportunities.

The Regatta project is a startup effort by Regatta Fitness LLC, which is revolutionizing the way people work out by providing an integrative technology platform for use in group settings (fitness classes or competition teams) and at-home. Whether you’re an Olympic rower, weekend warrior, or just someone looking to get into better shape, Regatta provides you with the complete experience: challenge yourself in competitive, team-based classes, track your progress, improve at home, and stay accountable by connecting with friends.

In order to facilitate this ambitious goal, Microsoft worked together with Regatta Fitness LLC to build the foundation for a technology solution that will be used in group rowing studios to facilitate exercise sessions.
